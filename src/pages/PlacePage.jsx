...
export default function PlacePage({ place }) {
  ...
  let russiaTime = new Date().toLocaleString("en-Us",{timeZone:"Europe/Moscow", timeStyle:"short", hourCycle:"h24"})
  let dubaiTime = new Date().toLocaleString("en-Us",{timeZone:"Asia/Dubai", timeStyle:"short", hourCycle:"h24"})

  // new Date(checkOut?.checkOut)
  // let russiaCheckIn = new Date(place.checkIn)
  let russiaCheckIn = new Date(place.checkIn).toLocaleString("en-Us",{timeZone:"Europe/Moscow", timeStyle:"short", hourCycle:"h12"});
