...
export default function LandingPage() {
  ...
  console.log({
    allAvailablePlacesByCityAndTypeL: allAvailablePlacesByCityAndTypeL,
  });
  ...
  const allAvailableRoomsByCityAndTypeL = useSelector(
    (state) => state?.place?.fetchedAllAvailableRoomsByCityAndType
  );

  // const [places, setPlaces] = useState(allRoomsL);
  ...
  const roomType = useSelector((state) => state?.booking?.type) || null;
  console.log({ roomType: roomType });
  const guestCity = useSelector((state) => state?.booking?.city) || null;
  ...
  //   let type = roomType?.type;
  //   let city = guestCity?.city;
  //   getAllAvailableRoomsByCityAndType(city, type).then((response) => {
  //     setPlaces(response);
  //   });
  // };
  ...
  // useEffect(() => {
  //   // dispatch(getAllAvailableRoomsByCityAndType(city, type));
  ...
  useEffect(() => {
    let type = roomType?.type;
    let city = guestCity?.city;
    dispatch(getAllPlacesByCityAndType(city, type));
          ...
          {places.length < 1 ? (
            <div className="py-2 mt-8 mb-8 flex flex-row justify-center items-center">
              <div className="text-gray-900 text-base">
                No {roomType?.type} is available in {guestCity?.city} at the
                moment
              </div>
            </div>
          ) : (
            ...
            {places &&
              places?.map((place, index) => (
                ...
                >
                  ...
                  <div className="flex flex-row gap-8 px-6 py-6 bg-gray-50 rounded-lg ml-8 w-[750px]">
                    {/* Section1: Photo */}
                    ...
                    {/* Section2: Info*/}
                    <section className="flex flex-col justify-start items-start gap-3 w-[45%]">
                      <div className="flex gap-2">
                        ...
                        <div className="flex justify-start items-start h-[14px] mt-3">
                          ...
                          strokeWidth="1.5"
                          stroke="currentColor"
                          className="w-6 h-6 stroke-yellow-500 fill-yellow-500 hover:stroke-black"
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                    ...
                    <section className="flex flex-col gap-3 w-[25%]">
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="text-gray-900 text-2xl">RUB 8,900</div>
                        <div className="text-xs text-gray-700">
                      ...
                      <div className=" bg-blue-500 rounded-lg px-2 py-2 w-[150px] flex flex-row hover:opacity-90 mt-4">
                        <div className="text-white">See availability</div>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
